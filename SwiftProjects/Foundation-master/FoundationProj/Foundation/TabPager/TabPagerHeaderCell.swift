...
class TabPagerHeaderCell: UICollectionViewCell, Reusable {
    ...
    class TabPagerHeaderDefault {
        ...
        static let indicatorColor: UIColor = R.Color.base
        static let selectedFont = UIFont.notoSans(.bold, size: 17)
        static let selectedColor: UIColor = R.Color.default
        static let deSelectedFont = UIFont.notoSans(.regular, size: 17)
        static let deSelectedColor: UIColor = R.Color.default ~ 70%
    }
