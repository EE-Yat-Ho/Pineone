...
class MultipleChoiceQuestionViewController_AutoResizingMask: UIViewController {
    ...
    func addConstraintUseAnchor(){
        ...
        scrollView.center = CGPoint(x: self.view.bounds.midX, y: self.view.bounds.midY)
        scrollView.autoresizingMask = [.flexibleLeftMargin, .flexibleRightMargin , .flexibleTopMargin, .flexibleBottomMargin]
